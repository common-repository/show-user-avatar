...
If you want to display the current user avatar, you can use the following shortcode [avatar]

== Frequently Asked Questions ==

=How can i use it?=

Just activate the plugin and put the shortcode [avatar] where you want the avatar to display.
